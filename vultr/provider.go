...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"vultr_kubernetes_node_pool_labels": dataSourceVultrKubernetesNodePoolLabels(),
			"vultr_kubernetes_node_pool_taints": dataSourceVultrKubernetesNodePoolTaints(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"vultr_kubernetes_node_pool_label":  resourceVultrKubernetesNodePoolLabel(),
			"vultr_kubernetes_node_pool_taint":  resourceVultrKubernetesNodePoolTaint(),
